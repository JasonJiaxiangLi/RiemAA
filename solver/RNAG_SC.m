function [x, cost, info, options] = RNAG_SC(problem, x, options)
...
%
% This is the version for strongly convex function.
%
...
% with the field retr/invretr/transp defined as exp/log/parallel transport
    ...
    while true
        ...
        tempcoeff = sqrt(xi * q)/(1 + sqrt(xi*q));
        y = M.retr(x, M.lincomb(x, tempcoeff, vbar) );
        ...
        vbar = M.lincomb(y, (1- sqrt(q/xi)), v, -sqrt(q/xi)/mu, grady);
