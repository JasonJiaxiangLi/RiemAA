...
%
% Modified to be fixed-stepsize RGD
%
% function [x, cost, info, options] = steepestdescent_mod(problem)
% function [x, cost, info, options] = steepestdescent_mod(problem, x0)
% function [x, cost, info, options] = steepestdescent_mod(problem, x0, options)
% function [x, cost, info, options] = steepestdescent_mod(problem, [], options)
%
...
%       Added support for options.hook.
    ...
    while true
        ...
        curstep = problem.M.lincomb(x, stepsize, desc_dir);
        newx = problem.M.retr(x, curstep);
